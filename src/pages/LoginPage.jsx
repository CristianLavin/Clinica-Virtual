...
import { Heart, Mail, Lock, User, Briefcase, ArrowLeft } from 'lucide-react';
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background blobs */}
      <div className="absolute top-[-10%] right-[-10%] w-[30%] h-[30%] bg-pink-100/40 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[30%] h-[30%] bg-blue-100/40 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="w-full max-w-lg relative z-10">
        ...
        <div className="bg-white rounded-[40px] shadow-2xl shadow-gray-200/50 border border-gray-100 p-10 md:p-12">
          <div className="text-center space-y-4 mb-10">
            ...
            <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">¡Hola de nuevo!</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="group space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-pink-500/10 focus:border-pink-500 outline-none transition-all font-medium"
                  />
                </div>
              </div>
            ...
            <div className="pt-6 text-center">
              <p className="text-gray-400 font-medium">
                ...
                <Link to="/register" className="text-pink-600 font-extrabold hover:text-pink-700 transition-colors">
                  Regístrate gratis
                </Link>
              </p>
            </div>
